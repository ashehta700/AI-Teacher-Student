...
const v4Player = new YT.Player('v4Player', {
  height: '315',
  width: '100%',
  videoId: 'G6G5QUeRvlk', // Update this with the ID of your third video
  events: {
...
const v5Player = new YT.Player('v5Player', {
  height: '315',
  width: '100%',
  videoId: '5NtirmBK3qc', // Update this with the ID of your third video
  events: {
...
const v6Player = new YT.Player('v6Player', {
  height: '315',
  width: '100%',
  videoId: 'dHCVFBBy3rk', // Update this with the ID of your third video
  events: {
...
const v7Player = new YT.Player('v7Player', {
  height: '315',
  width: '100%',
  videoId: 'nCmf0fRpo6M', // Update this with the ID of your third video
  events: {
...
const v8Player = new YT.Player('v8Player', {
  height: '315',
  width: '100%',
  videoId: '2Y1ewa-nJ4o', // Update this with the ID of your third video
  events: {
...
const v9Player = new YT.Player('v9Player', {
  height: '315',
  width: '100%',
  videoId: 'ri04JaVAkxE', // Update this with the ID of your third video
  events: {
...
const v10Player = new YT.Player('v10Player', {
  height: '315',
  width: '100%',
  videoId: 'kyP1E0vb274', // Update this with the ID of your third video
  events: {
...
const v11Player = new YT.Player('v11Player', {
  height: '315',
  width: '100%',
  videoId: '7WP05jo2sCE', // Update this with the ID of your third video
  events: {
...
const v12Player = new YT.Player('v12Player', {
  height: '315',
  width: '100%',
  videoId: 'NQHEBLyvdJc', // Update this with the ID of your third video
  events: {
...
const v13Player = new YT.Player('v13Player', {
  height: '315',
  width: '100%',
  videoId: 'F1rIfTQCn8A', // Update this with the ID of your third video
  events: {
...
const v14Player = new YT.Player('v14Player', {
  height: '315',
  width: '100%',
  videoId: 'nTCDPT0fyrU', // Update this with the ID of your third video
  events: {
...
const v15Player = new YT.Player('v15Player', {
  height: '315',
  width: '100%',
  videoId: 'UPAG-yaeGBg', // Update this with the ID of your third video
  events: {
